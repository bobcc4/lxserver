...
- **全新名称**：软件中文名统一为“音云”，英文名统一为“Yintuan”，覆盖 Web、PWA、Electron、Subsonic、文档及发布元数据。
- **全新图标**：采用深蓝底、白色祥云与居中双音符的 Y2-1 方案，统一用于 Web、PWA、文档和桌面客户端。
- **桌面端兼容**：Windows、macOS 和 Linux 安装包统一使用 `Yintuan` 名称；升级时自动迁移旧桌面版保存的存储目录配置。
